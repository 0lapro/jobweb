...
public class AdminController implements Serializable {
    ...
    private List<Employee> WascUserlist;
    AdminDAO dao;
    ...
    public void init() {
        ...
        try {
            ...
            WascUserlist = dao.getEmployeeList();
    ...
    public void setEmployeelist(List<Employee> WascUserlist) {
        this.WascUserlist = WascUserlist;
    }
