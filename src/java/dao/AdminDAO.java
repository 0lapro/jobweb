...
public class AdminDAO {
	...
	public List<Employee> getEmployeeList() throws SQLException {
		PreparedStatement ps = con
				.prepareStatement("select firstname,lastname,gender,country,city,company from jobweb_db.employee");
	...
	public String getAboutus() throws SQLException {
		PreparedStatement ps = con
				.prepareStatement("select aboutus from jobweb_db.adminconfig");
		ResultSet result = ps.executeQuery();
		String aboutus = null;
		while (result.next()) {
	...
	public String getContactus() throws SQLException {
		PreparedStatement ps = con
				.prepareStatement("select contactus from jobweb_db.adminconfig");
		ResultSet result = ps.executeQuery();
	...
	public String getDisclaimer() throws SQLException {
		PreparedStatement ps = con
				.prepareStatement("select disclaimer from jobweb_db.adminconfig");
		ResultSet result = ps.executeQuery();
	...
	public void updateAboutus(String aboutus) {
		...
		try {
			ps = con.prepareStatement("update jobweb_db.adminconfig SET aboutus='"
	...
	public void updateContactus(String contactus) {
		PreparedStatement ps;
		try {
			ps = con.prepareStatement("update jobweb_db.adminconfig SET contactus='"
	...
	public void updateDisclaimer(String disclaimer) {
		PreparedStatement ps;
		try {
			ps = con.prepareStatement("update jobweb_db.adminconfig SET disclaimer='"
